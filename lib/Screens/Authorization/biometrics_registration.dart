...
class _BiometricsRegisterState extends State<BiometricsRegister> {
  ...
  void initState() {
    setState(() {
      authcontroller.bioMetricImage.value = "No Image";
    });
    _initValues();
    super.initState();
  }
  ...
  void _onStartLivelyness() async {
    ...
    if (response is String) {
      ...
      setState(() {
        ...
        authcontroller.bioMetricImage.value = _capturedImagePath!;
...
// Assuming _capturedImagePath is not null, you can create a File object like this:
      ...
      authcontroller.RegistrationwithImage(
          authcontroller.registerAutenticationBody, imageFile!
