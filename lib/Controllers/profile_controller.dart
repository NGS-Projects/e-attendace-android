...
class ProfileController extends GetxController {
  ...
  // Future<void> getEAProfile() async {
  ...
  Future<void> getEAProfileTwo() async {
    profiledataLoading(true);
    try {
      var response = await apiService.getRequest(
          //https://new-ram-blood-server.onrender.com
  ...
  // Edit Profile
  var eaeditProfileLoading = false.obs;

  // bool _switchValue = false;
  //var donorRegistrationData = {}.obs;
  Future<void> eaeditProfileForm(Map payload) async {
    eaeditProfileLoading(true);
    try {
      //
  ...
  Future<void> editProfilePicture(File file) async {
    ...
    try {
      ...
      print(response);
      if (data["message"] == "Updated image successfully") {
        Fluttertoast.showToast(
          msg: data["message"],
        );
        getEAProfileTwo();
  ...
  // Ulpoad Resume
  var uploadResumeLoading = false.obs;
  // var donorRegistrationData = {}.obs;
  // var donorMobileEntered = "".obs;
  Future<void> uploadResume(File file) async {
    ...
    //  donorMobileEntered.value = payload["mobile"];
    try {
      var response = await apiService.patchRequestUploadResume(
          //   var response = await apiService.postAuthRequest(
          // https://blood-server-us7o.onrender.com/auth/registor/donor
          endpoint: "auth/resume",
          // "auth/edit/profile/${storedloginsData["_id"]}",
  ...
  // Ulpoad Resume
  var uploadExperienceletterLoading = false.obs;
  // var donorRegistrationData = {}.obs;
  // var donorMobileEntered = "".obs;
  Future<void> uploadExperienceLetters(File file) async {
    uploadExperienceletterLoading(true);

    //  donorMobileEntered.value = payload["mobile"];
    try {
      var response = await apiService.patchRequestUploadLetters(
          //   var response = await apiService.postAuthRequest(
          // https://blood-server-us7o.onrender.com/auth/registor/donor
          endpoint: "auth/experience-letters",
          // "auth/edit/profile/${storedloginsData["_id"]}",
      ...
      Map data = jsonDecode(response);
      print(response);
      if (data["message"] == "Experience letter added") {
        Fluttertoast.showToast(
          msg: data["message"],
        );
        getEAProfileTwo();
      ...
      uploadExperienceletterLoading(false);
    }
  }
  // EAttendance
