...
class AuthController extends GetxController {
  ...
  TextEditingController EASignupFnameController = TextEditingController();
  TextEditingController EASignupLnameController = TextEditingController();
  TextEditingController EASignupEmailController = TextEditingController();
  TextEditingController EASignupEmpIDController = TextEditingController();
  TextEditingController EASignupDOBController = TextEditingController();
  TextEditingController EARoleController = TextEditingController();
  TextEditingController EAGenderController = TextEditingController();
  TextEditingController EASignuppasswordController = TextEditingController();
  TextEditingController EASigninEMPIDController = TextEditingController();
  TextEditingController EASignINpasswordController = TextEditingController();
  TextEditingController EAForgotpasswordController = TextEditingController();
  // EAttendance
  var selectedRegisterCompany = "".obs;
  var bioMetricImage = "No Image".obs;
  ...
  Future<void> forgotPasswordUpdate(Map payload) async {
    forgotPasswordLoading(true);
    try {
      var response = await apiService.patchRequestNoToken(
      ...
      Map data = response;
      print(response);
      if (data["message"] == "forgot password Link send successfully..!") {
        Fluttertoast.showToast(
          msg: data["message"],
        );
        Get.back();
